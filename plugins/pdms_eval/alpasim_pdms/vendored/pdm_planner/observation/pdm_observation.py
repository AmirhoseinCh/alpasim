...
#   projects/SimEngine/worldengine/components/agents/policy/pdm_planner/observation/pdm_observation.py
# Imports rewritten worldengine.components.agents.policy.pdm_planner -> alpasim_pdms.vendored.pdm_planner by alpasim_pdms.tools.vendor_pdm.
...
from alpasim_pdms.vendored.pdm_planner.observation.pdm_object_manager import (
    PDMObjectManager,
)
from alpasim_pdms.vendored.pdm_planner.observation.pdm_occupancy_map import (
    PDMOccupancyMap,
)
...
class PDMObservation:
    ...
    def __init__(
        ...
        :param observation_sample_res: sample resolution of forecast, defaults to 1
        """
        assert (
        ...
        self._observation_samples: int = (
            ...
            if proposal_sampling.num_poses
            > trajectory_sampling.num_poses - 1
            else trajectory_sampling.num_poses - 1
        )
