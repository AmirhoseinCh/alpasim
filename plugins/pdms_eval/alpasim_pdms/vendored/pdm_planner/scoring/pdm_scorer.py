...
#   projects/SimEngine/worldengine/components/agents/policy/pdm_planner/scoring/pdm_scorer.py
...
from alpasim_pdms.vendored.pdm_planner.scoring.pdm_comfort_metrics import (
    ego_is_comfortable,
)
from alpasim_pdms.vendored.pdm_planner.scoring.pdm_scorer_utils import (
    get_collision_type,
)
...
from alpasim_pdms.vendored.pdm_planner.utils.pdm_path import PDMPath
